...
def get_image_colorizer_(
    path_ = 'src/core/base_libs/deoldifier/', render_factor: int = 35, artistic: bool = True
) -> ModelImageVisualizer:
    if artistic:
        return get_artistic_image_colorizer(root_folder=path_, render_factor=render_factor)
    else:
        return get_stable_image_colorizer(root_folder=path_, render_factor=render_factor)
